...
% NORMAL MEASUREMENTS (100 repetitions)

% Unicycle Circle
% State RMSE: 0.020 +/- 0.007
% Input RMSE: 0.227 +/- 0.068

% Unicycle lemniscate
% State RMSE: 0.030 +/- 0.002
% Input RMSE: 0.857 +/- 0.023

% Helicopter Circle
% State RMSE: 0.034 +/- 0.013
% Input RMSE: 0.096 +/- 0.011

% Helicopter lemniscate
% State RMSE: 0.686 +/- 0.001
% Input RMSE: 0.302 +/- 0.007



% MEASUREMENTS WITH NOISE (20 repetitions)

% Unicycle Circle
% State RMSE: 0.056 +/- 0.015
% Input RMSE: 0.634 +/- 0.190

% Unicycle lemniscate
% State RMSE: 0.204 +/- 0.251
% Input RMSE: 1.037 +/- 0.106

% Helicopter Circle
% State RMSE: 1.073 +/- 0.329
% Input RMSE: 0.215 +/- 0.025

% Helicopter lemniscate
% State RMSE: 1.169 +/- 0.207
% Input RMSE: 0.569 +/- 0.071
...
single run over the lemniscate trajectory (\itt{the more challenging one})
...
\begin{figure}[htb]
	...
	\caption{State (\itt{red}) and Input (\itt{blue}) RMSE values for the Unicycle (\itt{left}) and Helicopter
		(\itt{right}) models over the lemniscate trajectory with different prediction horizon
